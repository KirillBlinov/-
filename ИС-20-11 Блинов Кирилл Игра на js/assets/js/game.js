    ...
    loop() {
        requestAnimationFrame(() => {
            if (!this.pause) {
                ...
                $('.apple').css('animation','rotate infinite .6s linear').show();
                $('.orange').css('animation','rotate infinite .7s linear').show();
                $('.banana').css('animation','rotate infinite .8s linear').show();
                ...
                $('.apple').css('animation','none').show();
                $('.banana').css('animation','none').show();
                $('.orange').css('animation','none').show();
            }
            if (!this.ended) {
                this.loop();
            }
